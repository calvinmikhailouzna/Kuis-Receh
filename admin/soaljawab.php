...
$(document).ready(function() {
  ...
  function edit_soal(id) {
    $('#isi_editsoal').load('admin/edit_soal.php?id='+id);
  }

 function edit_jawaban(id) {
    // alert(id);
    $('#isi_editjawaban').load('admin/edit_jawaban.php?id='+id);
  }
  ...
  function hapus_soal(id) {
    ...
    function(isConfirm) {
      if (isConfirm) {
        $.ajax({
            url : "admin/hapus_soal.php",
            type: "POST",
            data: {id:id},
            success: function(data){
                swal("Deleted!", "Data has been deleted.", "success");
                $('#isitabel').load('admin/isitabel.php');
            },
...
function tambah_jawaban(id){
 ...
 function saving_tambah_jawaban(){
  		var url = "admin/tambah_jawaban.php";
  ...
  function saving_jawaban() {
    var url = "admin/ubah_jawaban.php";
