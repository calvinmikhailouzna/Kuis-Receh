...
$(document).ready(function() {
  ...
  function edit_user(id) {
    $('#isi_edituser').load('admin/edit_user.php?id='+id);
  }
  ...
  function hapus_user(id) {
    ...
    function(isConfirm) {
      if (isConfirm) {
        $.ajax({
            url : "admin/hapus_user.php",
            type: "POST",
            data: {id:id},
            success: function(data){
                swal("Deleted!", "Data has been deleted.", "success");
                $('#isitabeluser').load('admin/isitabeluser.php');
            },
